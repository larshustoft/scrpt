...
export default function HQPage() {
  ...
  return (
    <div className="relative overflow-hidden" style={{ height: "calc(100vh - 64px)" }}>
      ...
      {/* greeting top-left, the book low on the left margin — like STCKR */}
      <div className="relative h-full max-w-[1280px] mx-auto px-12 flex flex-col justify-between pt-24 pb-14">

...
RESEARCH_SYSTEM_PROMPT = """You are the SCRPT Research Engine — an autonomous market analyst
...
if __name__ == "__main__":
    ...
    print("\n" + "="*70)
    print("  SCRPT RESEARCH ENGINE — Demand-Validated Recommendations")
    print("="*70)

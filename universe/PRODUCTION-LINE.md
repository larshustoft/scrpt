...
66. **The camera is the intro's camera** (Lars, 2026-09-03: "which model made the intro and the lullaby?" — Seedance 2.5 with the plates as references, hand-picked). Character shots (medium, close, detail) are shot on Seedance 2.5 with the cast plates, the closest pose, the object states and the storyboard frame attached, and judged by identity against those plates; wide shots are drifts over the approved still and cost nothing; a reference take refused twice holds on its picture. gen4_turbo (one frame, no references, ~1/3 inventions) is retired for episodes. Gate 43. Price: 150 credits per 5-second Seedance take.
